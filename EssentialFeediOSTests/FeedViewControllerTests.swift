...
class FeedViewControllerTests : XCTestCase
{
    ...
    {
        //Temporal Coupling : Requiring certain methods of a class to be called in a specific order
        ...
        XCTAssertEqual(loader.loadFeedCallCount, 2, "Expected another loading request once the user initiates a load")
        
        sut.simulateUserInitiatedFeedReload()
        XCTAssertEqual(loader.loadFeedCallCount, 3, "Expected a third loading request once the user initiates another load" )
    }
    ...
    func test_loadingFeedIndicator_isVisibleWhileLoadingFeed()
    {
        ...
        XCTAssertFalse(sut.isShowingLoadingIndicator,"Expected no loading indicator completes successfully")
